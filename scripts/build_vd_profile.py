...
def main():
    ...
    parser.add_argument('--profile-source',type=Path,default=ROOT/'profiles/clients/vd-1.34.22.0-research.json')
    ...
    try:
        ...
        apk=ROOT/'profile-vd/build/outputs/apk'/args.variant/f'profile-vd-{args.variant}.apk'
